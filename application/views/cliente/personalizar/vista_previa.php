...
<div class="titulo_imprimir">
	<h3>Vista previa<br><img src="<?php echo base_url('templates/usuario/images/noticia.png'); ?>"/></h3>
</div>
<div class="contenedor_previa">
	...
	<div class="contenedor_imprimir">
        <a href="javascript:void(0);" onclick="imprimir();">Imprimir</a>
        <a id="terminar_creacion" href="<?php echo base_url('cancelar_disenio'); ?>">Terminar creación</a>
    </div>
</div>
<script>
