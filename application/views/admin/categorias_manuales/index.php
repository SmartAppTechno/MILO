...
<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-lg-10">
		...
		<form role="form" action="<?php echo base_url('nueva_categoria_manuales'); ?>" method="post">
				...
				<tbody>
					<?php
						foreach($categorias as $categoria){
							...
							echo '<td class="acciones"><form role="form" action="'.base_url('editar_categoria_manuales').'" method="post">
			                        <input type="hidden" name="id" value="'.$categoria['id'].'">
			                        <button type="submit" class="btn btn-w-m btn-primary"><i class="fa fa-pencil"></i></button>
			                    </form>
			                    <form role="form" action="'.base_url('eliminar_categoria_manuales').'" method="post">
			                        <input type="hidden" name="id" value="'.$categoria['id'].'">
