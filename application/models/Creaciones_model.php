...
class Creaciones_model extends CI_Model
{
	...
	public function ver_creacion($id){
		$this->db->select('t1.id,t1.impresiones,t1.fecha,t2.nombre as cliente,t3.nombre as producto,t4.nombre as ocasion,t5.nombre as disenio,t1.foto,t1.cristal,t1.propia_impresora');
