<?php
class Videos_categorias_model extends CI_Model
{
	...
	public function get_categorias(){
		...
		$this->db->from('tbl_cap_videos_categorias as t1,tbl_tipo_membresia as t2');
	...
	public function insertar_categoria($nombre,$membresia){
        ...
        $this->db->insert('tbl_cap_videos_categorias',$data);
	}
	...
	public function guardar_categoria($id,$nombre,$membresia){
        ...
        $this->db->where('id',$id);
        $this->db->update('tbl_cap_videos_categorias',$data);
	}
	public function eliminar_categoria($id){
		$this->db->where('id',$id);
        $this->db->delete('tbl_cap_videos_categorias');
	}
